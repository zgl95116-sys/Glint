...
═══ CONTENT ═══
所有文字输出必须使用简体中文，包括 AI 语音、信息标签、数据标注等。仅品牌装饰文字可用英文（如 GLINT · MORNING）。
...
═══ TASK ENTRY — AI 可执行任务入口 ═══
When the prompt mentions an actionable task (叫车、抢票、回复消息、点外卖、改签、导航等), render a TASK BUTTON:
- Style: pill/capsule shape, gradient border with subtle breathing glow animation, backdrop-filter:blur
- Size: 14-16px text, padding 10px 20px, border-radius 24px
- Color: use the scene's accent color for the border gradient; background rgba(255,255,255,0.06)
- Icon + text format: "🤖 帮我定时去大麦抢票" / "🚕 帮我叫车去公司"
- Position: as a flex child in the main column, near the relevant info it acts on
- Max 1-2 task buttons per screen. They should feel like part of the art, not a UI widget.
- Add a subtle @keyframes glow animation on the border to signal "this is tappable"

NEVER: clocks/time displays, date displays, any form of HH:MM or digital clock, text below 12px, card grids, bullet lists, notification layouts, uniform text sizing, elements exceeding viewport, position:absolute on text/cards, generic/template-feeling output, plain black or white backgrounds.`;
...
const FEW_SHOT_EXAMPLES: Array<{ user: string; model: string }> = [
  ...
  },
  {
    ...
    model: `<!doctype html><html><head><meta name="color-scheme" content="dark"><style>@keyframes scan-line{from{top:-5%}to{top:105%}}@keyframes dash{to{stroke-dashoffset:-60}}@keyframes slide-in{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes glow{0%,100%{text-shadow:0 0 20px rgba(80,170,255,0.2)}50%{text-shadow:0 0 40px rgba(80,170,255,0.4),0 0 80px rgba(80,170,255,0.1)}}@keyframes plane-move{0%{offset-distance:0%;opacity:0}5%{opacity:1}95%{opacity:1}100%{offset-distance:100%;opacity:0}}</style></head><body style="margin:0;overflow:hidden;width:100vw;height:100vh;font-family:var(--font-mono);background:linear-gradient(170deg,#060e18 0%,#0a1220 50%,#08101a 100%)"><div style="position:absolute;inset:0;background:linear-gradient(rgba(80,170,255,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(80,170,255,0.03) 1px,transparent 1px);background-size:20% 20%;pointer-events:none"></div><div style="position:absolute;left:0;right:0;height:2px;background:linear-gradient(to right,transparent,rgba(80,170,255,0.15),transparent);animation:scan-line 4s linear infinite;pointer-events:none"></div><svg style="position:absolute;inset:0;width:100%;height:100%" viewBox="0 0 390 844"><path d="M320,200 Q195,420 90,700" fill="none" stroke="rgba(255,180,50,0.15)" stroke-width="2" stroke-dasharray="8 6" style="animation:dash 3s linear infinite"/><path d="M320,200 Q195,420 90,700" fill="none" stroke="rgba(255,180,50,0.05)" stroke-width="20"/><circle cx="320" cy="200" r="5" fill="rgba(80,170,255,0.8)"/><circle cx="320" cy="200" fill="none" stroke="rgba(80,170,255,0.3)" stroke-width="1"><animate attributeName="r" values="5;25;5" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values="1;0;1" dur="3s" repeatCount="indefinite"/></circle><circle cx="90" cy="700" r="6" fill="rgba(255,180,50,0.9)"/><circle cx="90" cy="700" fill="none" stroke="rgba(255,180,50,0.3)" stroke-width="1"><animate attributeName="r" values="6;30;6" dur="2.5s" repeatCount="indefinite"/><animate attributeName="opacity" values="1;0;1" dur="2.5s" repeatCount="indefinite"/></circle><circle r="3" fill="#fff" style="offset-path:path('M320,200 Q195,420 90,700');animation:plane-move 8s linear infinite"/></svg><div style="position:absolute;top:21%;right:5%;font-size:13px;color:rgba(80,170,255,0.4);letter-spacing:2px">北京 PEK</div><div style="position:absolute;bottom:19%;left:8%;font-size:13px;color:rgba(255,180,50,0.5);letter-spacing:2px">成都 CTU</div><div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:5% 6% 6%"><div style="animation:slide-in .7s ease both"><div style="font-size:clamp(48px,18vw,88px);font-weight:200;color:rgba(255,255,255,0.9);letter-spacing:-2px;animation:glow 4s ease infinite">CA1502</div><div style="display:flex;gap:16px;margin-top:8px;font-size:15px"><span style="color:rgba(255,130,40,0.8);font-weight:500">延误 40 分钟</span><span style="color:rgba(255,255,255,0.3)">预计 18:10 登机</span></div></div><div style="display:flex;gap:0;margin-top:16px;animation:slide-in .8s ease .15s both"><div style="flex:1;border-right:1px solid rgba(80,170,255,0.08);padding:12px 0"><div style="font-size:12px;color:rgba(80,170,255,0.4);letter-spacing:2px;margin-bottom:4px">登机口</div><div style="font-size:28px;font-weight:300;color:rgba(255,180,50,0.9)">B7</div></div><div style="flex:1;border-right:1px solid rgba(80,170,255,0.08);padding:12px 0 12px 16px"><div style="font-size:12px;color:rgba(80,170,255,0.4);letter-spacing:2px;margin-bottom:4px">落地天气</div><div style="font-size:28px;font-weight:300;color:rgba(255,255,255,0.7)">22° 🌧</div></div><div style="flex:1;padding:12px 0 12px 16px"><div style="font-size:12px;color:rgba(80,170,255,0.4);letter-spacing:2px;margin-bottom:4px">到达</div><div style="font-size:28px;font-weight:300;color:rgba(255,255,255,0.7)">19:50</div></div></div><div style="margin-top:auto;animation:slide-in .9s ease .3s both"><div style="background:rgba(255,255,255,0.03);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:16px;padding:18px;border:1px solid rgba(80,170,255,0.06);flex-shrink:0"><div style="font-size:17px;color:rgba(255,255,255,0.8);line-height:1.6">登机口换了，从你现在的位置<br><span style="font-size:22px;color:rgba(80,170,255,0.8);font-weight:500">步行 8 分钟</span> 到 B7</div><div style="margin-top:10px;font-size:15px;color:rgba(255,255,255,0.3)">全季酒店已改延迟入住 · 地铁约55分钟到</div></div></div><div style="text-align:center;margin-top:12px;flex-shrink:0;animation:slide-in 1s ease .45s both"><span style="font-size:12px;color:rgba(80,170,255,0.15);letter-spacing:4px">GLINT · FLIGHT</span></div></div></body></html>`,
  },
  {
    // Sunset — screen literally splits warm/cold, horizon SVG, bold color — CINEMATIC layout
    user: '[Style: Sunset gradient transition. Screen splits cool-office-blue at top to warm-golden at bottom, luminous horizon line. Layout: CINEMATIC]\n周五傍晚6:30，评审通过了，明天不上班。外面18°C晴适合跑步（3天没动了），快递到了驿站3号柜，冰箱还有昨天的菜够炒一顿。',
    model: `<!doctype html><html><head><meta name="color-scheme" content="dark"><style>@keyframes horizon-glow{0%,100%{opacity:.6;filter:blur(8px)}50%{opacity:1;filter:blur(12px)}}@keyframes rise{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)}}@keyframes sun-pulse{0%,100%{r:18;opacity:.9}50%{r:22;opacity:1}}</style></head><body style="margin:0;overflow:hidden;width:100vw;height:100vh;font-family:var(--font-display);background:linear-gradient(180deg,#1a2a4a 0%,#2a3a5a 25%,#8a5a3a 50%,#d4874a 70%,#e8a060 85%,#f0c080 100%)"><svg style="position:absolute;top:46%;left:0;width:100%;height:10px;overflow:visible" viewBox="0 0 400 10"><line x1="0" y1="5" x2="400" y2="5" stroke="rgba(255,220,150,0.5)" stroke-width="1"/><circle cx="200" cy="5" fill="#ffe0a0" opacity=".9"><animate attributeName="r" values="18;22;18" dur="4s" repeatCount="indefinite"/></circle><circle cx="200" cy="5" fill="none" stroke="rgba(255,220,150,.2)" stroke-width="1"><animate attributeName="r" values="25;45;25" dur="4s" repeatCount="indefinite"/><animate attributeName="opacity" values=".4;0;.4" dur="4s" repeatCount="indefinite"/></circle></svg><div style="position:absolute;top:42%;left:0;right:0;height:20%;background:linear-gradient(transparent,rgba(255,200,120,0.08),transparent);animation:horizon-glow 6s ease-in-out infinite;pointer-events:none"></div><div class="g-grain"></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:7% 7% 8%"><div style="animation:rise 1s ease both"><div style="font-size:14px;color:rgba(200,220,255,0.5);letter-spacing:4px">周五 · 下班了</div></div><div style="margin-top:8%;animation:rise 1s ease .2s both"><div style="font-size:15px;color:rgba(200,210,240,0.5);text-decoration:line-through;letter-spacing:1px">✓ 方案评审 · 已通过</div><div style="font-size:15px;color:rgba(200,210,240,0.4);text-decoration:line-through;margin-top:4px">✓ 明天不上班</div></div><div style="margin-top:auto;animation:rise 1.2s ease .4s both"><div style="font-size:clamp(22px,5.5vw,28px);font-weight:300;color:rgba(255,240,220,0.9);line-height:1.6;text-shadow:0 2px 12px rgba(0,0,0,0.3)">评审过了。<br>从现在开始，时间是你自己的。</div></div><div style="display:flex;gap:12px;margin-top:20px;flex-shrink:0;animation:rise 1.2s ease .6s both;flex-wrap:wrap"><div style="background:rgba(255,255,255,0.08);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:14px;padding:14px 16px;border:1px solid rgba(255,255,255,0.1);flex:1;min-width:40%"><div style="font-size:14px;color:rgba(255,240,220,0.9)">🏃 外面 18°C 晴</div><div style="font-size:13px;color:rgba(255,240,220,0.5);margin-top:2px">3 天没动了，适合跑步</div></div><div style="background:rgba(255,255,255,0.08);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:14px;padding:14px 16px;border:1px solid rgba(255,255,255,0.1);flex:1;min-width:40%"><div style="font-size:14px;color:rgba(255,240,220,0.9)">📦 快递到了</div><div style="font-size:13px;color:rgba(255,240,220,0.5);margin-top:2px">驿站 3 号柜</div></div></div><div style="text-align:center;margin-top:14px;flex-shrink:0;animation:rise 1.2s ease .8s both"><span style="font-size:12px;color:rgba(255,220,150,0.2);letter-spacing:5px">GLINT · SUNSET</span></div></div></body></html>`,
  },
  {
    // Weekend — ACTUALLY light theme, soft pastel watercolor, lazy serif — ASYMMETRIC layout
    user: '[Style: Lazy morning watercolor. Pale washes of pastel bleeding into each other like wet-on-wet painting. Layout: ASYMMETRIC]\n周六早上9:30，没闹钟的早晨。14°C多云转晴，小红书关注的博主更新了独居男生早餐vlog，豆瓣一部9.2分冰岛极光纪录片，Kindle《百年孤独》读到第147页。',
    model: `<!doctype html><html><head><meta name="color-scheme" content="light"><style>@keyframes w1{0%,100%{transform:translate(0,0) scale(1);opacity:.5}50%{transform:translate(15px,10px) scale(1.1);opacity:.65}}@keyframes w2{0%,100%{transform:translate(0,0) scale(1);opacity:.4}50%{transform:translate(-20px,15px) scale(1.08);opacity:.55}}@keyframes w3{0%,100%{transform:translate(0,0) scale(1);opacity:.35}50%{transform:translate(10px,-12px) scale(1.12);opacity:.5}}@keyframes soft-in{from{opacity:0;transform:translateY(16px)}to{opacity:1;transform:translateY(0)}}</style></head><body style="margin:0;overflow:hidden;width:100vw;height:100vh;font-family:var(--font-display);background:#f5f0e8"><div style="position:absolute;inset:0;overflow:hidden"><div style="position:absolute;top:-20%;right:-10%;width:70vmin;height:70vmin;border-radius:50%;background:radial-gradient(circle,rgba(255,180,190,.5),transparent 70%);filter:blur(60px);animation:w1 18s ease-in-out infinite"></div><div style="position:absolute;top:30%;left:-15%;width:60vmin;height:60vmin;border-radius:50%;background:radial-gradient(circle,rgba(180,220,200,.45),transparent 70%);filter:blur(60px);animation:w2 22s ease-in-out infinite"></div><div style="position:absolute;bottom:-10%;right:20%;width:55vmin;height:55vmin;border-radius:50%;background:radial-gradient(circle,rgba(200,190,240,.4),transparent 70%);filter:blur(60px);animation:w3 20s ease-in-out infinite"></div></div><div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:8% 7% 8%"><div style="animation:soft-in 1.2s ease both"><div style="font-size:16px;color:rgba(80,70,60,0.45);letter-spacing:3px">周六 · 没有闹钟的早晨</div></div><div style="margin-top:8%;animation:soft-in 1.2s ease .3s both"><div style="font-size:clamp(22px,5.5vw,28px);font-weight:300;color:rgba(60,50,40,0.8);line-height:1.6">没人找你。<br>今天是你的。</div></div><div style="margin-top:auto;display:flex;flex-direction:column;gap:10px"><div style="background:rgba(255,255,255,0.5);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:16px;padding:16px;border:1px solid rgba(0,0,0,0.04);animation:soft-in 1.2s ease .5s both"><div style="font-size:15px;color:rgba(60,50,40,0.75);line-height:1.6">📱 小红书博主更新了<br><span style="color:rgba(60,50,40,0.5)">独居男生的周末早餐 vlog</span></div></div><div style="display:flex;gap:10px"><div style="flex:1;background:rgba(255,255,255,0.5);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:16px;padding:14px;border:1px solid rgba(0,0,0,0.04);animation:soft-in 1.2s ease .65s both"><div style="font-size:14px;color:rgba(60,50,40,0.75)">🎬 豆瓣 9.2</div><div style="font-size:13px;color:rgba(60,50,40,0.45);margin-top:2px">冰岛极光纪录片</div></div><div style="flex:1;background:rgba(255,255,255,0.5);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-radius:16px;padding:14px;border:1px solid rgba(0,0,0,0.04);animation:soft-in 1.2s ease .8s both"><div style="font-size:14px;color:rgba(60,50,40,0.75)">📖 百年孤独</div><div style="font-size:13px;color:rgba(60,50,40,0.45);margin-top:2px">读到第 147 页</div></div></div></div><div style="text-align:center;margin-top:14px;flex-shrink:0;animation:soft-in 1.2s ease 1s both"><span style="font-size:12px;color:rgba(80,70,60,0.2);letter-spacing:5px">GLINT · WEEKEND</span></div></div></body></html>`,
  },
];
...
const ART_RULES: Array<{ test: RegExp; style: string; layout: ArtDirection['layout'] }> = [
  ...
  { test: /工作间隙|心流|专注|工位/i, style: 'Zen dashboard. Nearly empty screen. Three colored status dots (like traffic lights) as the visual center. The emptiness IS the message — nothing needs your attention.', layout: 'NEGATIVE SPACE' },
